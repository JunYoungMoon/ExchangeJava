...
class OrderServiceTest {
    ...
    void processOrder_shouldThrowExceptionWhenNoCoinHolding() {
        ...
        when(slaveCoinHoldingRepository.findByMemberIdxAndCoinType(memberIdx, "BTC")).thenReturn(Optional.empty());
    ...
    void processOrder_shouldThrowExceptionWhenInsufficientBalance() {
        ...
        when(slaveCoinHoldingRepository.findByMemberIdxAndCoinType(memberIdx, "BTC")).thenReturn(Optional.of(coinHolding));
