...
public class CoinInfoInitializer {
    ...
    public CoinInfoInitializer(SlaveCoinInfoRepository slaveCoinInfoRepository, RedisService redisService, SlaveCoinOrderRepository slaveCoinOrderRepository) {
